...
final class ScheduleViewController: UIViewController{
    private var days: Set<DayOfWeek>
    private let completion: (Set<DayOfWeek>) -> Void
    private var items: [DayOfWeek] {DayOfWeek.allCases}
    
    init(days: Set<DayOfWeek>, completion: @escaping (Set<DayOfWeek>) -> Void){
        self.days = days
